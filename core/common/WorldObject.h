...
ENUM(
		...
		// Opponents?
		WO_OPPONENT1, WO_OPPONENT2, WO_OPPONENT3, WO_OPPONENT4, WO_OPPONENT5,

		// center cirlce
		WO_CENTER_CIRCLE,

		// 2 Landmark goals
		WO_OWN_GOAL, WO_OPP_GOAL,

		WO_OWN_LEFT_GOALPOST, WO_OPP_LEFT_GOALPOST,

		WO_OWN_RIGHT_GOALPOST, WO_OPP_RIGHT_GOALPOST,

		// Unknown goals and goal posts
		WO_UNKNOWN_GOAL, WO_UNKNOWN_LEFT_GOALPOST, WO_UNKNOWN_RIGHT_GOALPOST,
		WO_UNKNOWN_GOALPOST,
		...
		WO_OPP_FIELD_LEFT_L, WO_OPP_FIELD_RIGHT_L, WO_OPP_PEN_LEFT_L,
		WO_OPP_PEN_RIGHT_L, WO_OWN_PEN_RIGHT_L, WO_OWN_PEN_LEFT_L,
		WO_OWN_FIELD_RIGHT_L, WO_OWN_FIELD_LEFT_L,

		WO_OPP_BACK_RIGHT_GOAL_L, WO_OPP_BACK_LEFT_GOAL_L,

		WO_OWN_BACK_RIGHT_GOAL_L, WO_OWN_BACK_LEFT_GOAL_L,

		// T intersections (yellow to blue, top to bottom)
		WO_OPP_PEN_LEFT_T, WO_OPP_PEN_RIGHT_T, WO_CENTER_TOP_T,
		WO_CENTER_BOTTOM_T, WO_OWN_PEN_RIGHT_T, WO_OWN_PEN_LEFT_T,

		WO_OPP_FRONT_RIGHT_GOAL_T, WO_OPP_FRONT_LEFT_GOAL_T,

		WO_OWN_FRONT_RIGHT_GOAL_T, WO_OWN_FRONT_LEFT_GOAL_T,

		WO_UNKNOWN_FIELD_LINE_1, WO_UNKNOWN_FIELD_LINE_2,
		WO_UNKNOWN_FIELD_LINE_3, WO_UNKNOWN_FIELD_LINE_4,

		// Horizontal Lines (right to left)
		WO_OPP_GOAL_LINE, WO_OPP_PENALTY, WO_CENTER_LINE, WO_OWN_PENALTY,
		WO_OWN_GOAL_LINE,

		WO_OPP_BOTTOM_GOALBAR, WO_OWN_BOTTOM_GOALBAR,

		// Vertical Lines (top to bottom)
		WO_TOP_SIDE_LINE, WO_PENALTY_TOP_OPP, WO_PENALTY_TOP_OWN,
		WO_PENALTY_BOTTOM_OPP, WO_PENALTY_BOTTOM_OWN, WO_BOTTOM_SIDE_LINE,

		WO_OPP_LEFT_GOALBAR, WO_OPP_RIGHT_GOALBAR, WO_OWN_LEFT_GOALBAR,
		WO_OWN_RIGHT_GOALBAR,

		WO_BEACON_PINK_YELLOW, WO_BEACON_YELLOW_PINK, WO_BEACON_BLUE_YELLOW,
		WO_BEACON_YELLOW_BLUE, WO_BEACON_PINK_BLUE, WO_BEACON_BLUE_PINK,

		// penalty crosses
		WO_UNKNOWN_PENALTY_CROSS, WO_OWN_PENALTY_CROSS, WO_OPP_PENALTY_CROSS,
...
const int NUM_INTERSECTIONS = WO_OWN_FRONT_LEFT_GOAL_T - INTERSECTION_OFFSET
		+ 1;
