...
public:
  ...
  void drawLines(ImageWidget *image);
  void drawYellowGoal (ImageWidget *image);
  void getPointsForLine(FieldLine *fieldLine, bool isHorizontal, int &x1, int &y1, int &x2, int &y2);
  void drawBallCands(ImageWidget* image);
  void drawBall(ImageWidget* image);
  void drawPenaltyCross(ImageWidget *image);
  ...
  void drawCalibrationField(ImageWidget *image);
